...
- campaigns: id, client_id, name, status, target_title, target_company_size, target_industry, target_geography, offer_type, copy_patterns[], send_volume, open_rate, reply_rate, bounce_rate, positive_reply_count, negative_reply_count, meetings_booked, list_source, campaign_start_date
- sequence_steps: id, campaign_id, step_number, variant_label, subject_line, email_body, open_rate, reply_rate, offer_type, copy_patterns[]
- leads: id, campaign_id, email, first_name, last_name, company, title, category, reply_sentiment, meeting_booked
