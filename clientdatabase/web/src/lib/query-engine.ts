...
- contacts: id, email, first_name, last_name, full_name, title, seniority, department, linkedin_url, company_name, company_domain, company_industry, company_size, company_revenue, city, state, country, tags[], is_unsubscribed, is_hostile_opt_out, source_platform, total_campaigns, total_emails_sent, total_replies, overall_status, meeting_booked
