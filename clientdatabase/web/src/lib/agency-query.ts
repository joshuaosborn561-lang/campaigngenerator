...
- campaigns: id, client_id, source_platform (smartlead|heyreach), smartlead_campaign_id, heyreach_campaign_id, name, status, campaign_start_date, target_title, target_company_size, target_industry, target_geography, offer_type (legacy classifier), copy_patterns[], lead_source, play_used, offer_framing, cta_type, sequence_length, icp_job_title, icp_company_size, icp_geography, send_volume, open_rate, reply_rate, bounce_rate, positive_reply_count, negative_reply_count, referral_count, ooo_count, not_interested_count, meetings_booked, meetings_per_500 (generated), list_source, gemini_offer_profile (jsonb — offer decomposition + apollo_style_email_signals from ≤25 sampled emails), inferred_icp (jsonb — ICP + apollo_style_icp_signals from lead samples), offer_sample_fingerprint, inferred_at, sequence_fingerprint, created_at, updated_at
- sequence_steps: id, campaign_id, step_number, variant_label, subject_line, email_body, delay_days, open_rate, reply_rate, click_rate, offer_type, copy_patterns[], inferred_offer_angle (jsonb — per-variant decomposition + apollo_style_email_signals), inferred_at, content_fingerprint, created_at
- leads: id, campaign_id, smartlead_lead_id, email, first_name, last_name, company, title, industry, company_size, company_revenue, seniority, department, city, state, country, status, category, reply_sentiment, meeting_booked, has_replied, is_unsubscribed, is_hostile, created_at, updated_at
- contacts: unified lead/person records (email, title, seniority, department, company_*, technologies[], funding_stage, job_function, hq_location, person_keywords[], buying_intent_topics[], naics_or_industry_code, company_public_private, years_in_role, education_summary, is_unsubscribed, is_hostile_opt_out, city, state, country, …)
