...
- contacts: unified lead/person records (email, title, seniority, department, company_*, is_unsubscribed, is_hostile_opt_out, city, state, country, …)
