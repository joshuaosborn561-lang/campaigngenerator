...
function ContactsPageContent() {
  ...
  function onClientScopeChange(nextId: string) {
    if (nextId) {
      router.replace(`/contacts?client_id=${encodeURIComponent(nextId)}`);
    } else {
    ...
    <div className="app-layout">
      ...
      <aside className="filter-panel">
        ...
        <div className="filter-group">
          ...
          >
            <option value="">All contacts (agency-wide)</option>
            {clientOptions.map((c) => (
                ...
                <tr>
                  <td colSpan={12}>
                    <div className="empty-state">
                      ...
                      <div>Sync your SmartLead and HeyReach data, or adjust your filters</div>
                    </div>
                  </td>
                </tr>
              ) : (
  ...
  return (
    <Suspense
      fallback={
        <div className="app-layout">
          <AppSidebar active="contacts" />
          <aside className="filter-panel" style={{ padding: 16 }}>
